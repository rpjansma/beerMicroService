...
public class ControllersExceptionHandler {
    ...
    public ResponseEntity<List> validationErrorHandler(ConstraintViolationException error) {
    ...
    public ResponseEntity<List> handleBindException(BindException error) {
